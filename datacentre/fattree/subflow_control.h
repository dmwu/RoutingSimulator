...
class SubflowControl: public EventSource{
 public:
  SubflowControl(simtime_picosec scanPeriod, Logfile* lg, SinkLoggerSampling* sl,EventList& eventlist,TcpRtxTimerScanner* rtx,vector<route_t*>*** np, std::ofstream* p,int max_subflows);
  void doNextEvent();
